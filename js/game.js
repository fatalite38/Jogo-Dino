    ...
    let intervaloEsquerda = setInterval(() => {
        ...
        if(cactoPosition <= -60) {
            ...
            background.removeChild(cacto);
                    ...
                    cactoPosition <= 60 &&
                    dinoPosition <= 60) {
                document.body.innerHTML = '<h1 class="fim-de-jogo">Game Over</h1> <h2 class="fim-de-jogo" id="placar">Placar: </h2>';
                document.querySelector('#placar').innerText =  `Score: ${placar}`; 
